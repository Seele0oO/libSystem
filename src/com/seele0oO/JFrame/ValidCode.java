...
public class ValidCode extends JComponent implements MouseListener {
	...
	protected void paintComponent(Graphics g) {
		...
		/*
		 * i = 0; len = 300; for (; i < len; i++) { int x = random.nextInt(width); int y
		 * = random.nextInt(height); g2d.setColor(getRandColor(150, 180));
	...
	@Override
	public void mouseClicked(MouseEvent e) {  //单击验证码图片刷新验证码
		nextCode();
	}
